...
def main(config):
    ...
    if config["fan_bend_angle"] > 0:
        femesh_all_2["points"] = fan_single_cylinder(
            femesh_all_2["points"],
            bend_point=config["fan_bend_point"],
            bend_angle=config["fan_bend_angle"],
            axis=config["fan_bend_axis"],
        )
    ...
    plot_femesh_plotly_2(
        ...
        0,
        f"reference_cylinder_bp{config['fan_bend_point']}_ban{config['fan_bend_angle']}_bax{config['fan_bend_axis']}_r{config['rotation_inx']}_h".replace(
            ".", "_"
        ),
        f"reference_cylinder_bp{config['fan_bend_point']}_ban{config['fan_bend_angle']}_bax{config['fan_bend_axis']}_r{config['rotation_inx']}_p".replace(
            ".", "_"
        ),
    )
    # Point cloud
    plot_point_cloud_plotly(
        rotated_mesh["points"],
        0,
        f"reference_cylinder_bp{config['fan_bend_point']}_ban{config['fan_bend_angle']}_bax{config['fan_bend_axis']}_r{config['rotation_inx']}_pc_h".replace(
            ".", "_"
        ),
        f"reference_cylinder_bp{config['fan_bend_point']}_ban{config['fan_bend_angle']}_bax{config['fan_bend_axis']}_r{config['rotation_inx']}_pc_p".replace(
            ".", "_"
        ),
    )
    ...
    tch.save(
        rotated_mesh,
        f"{config['log_directory']}/reference_cylinder_bp{config['fan_bend_point']}_ban{config['fan_bend_angle']}_bax{config['fan_bend_axis']}_r{config['rotation_inx']}_mesh.pth".replace(
            ".", "_"
        ),
    )
    ...
    tch.save(
        all_meshes_generated[:full_range],
        f"{config['log_directory']}/all_meshes_generated.pth",
    )
    tch.save(
