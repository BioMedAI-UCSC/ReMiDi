...
def main(config):
    ...
    # 3D Mesh
    plot_femesh_plotly_2(scaled_mesh, setup.pde['compartments'], 0, f"reference_cylinder_{config['deformation_bend']}_{config['deformation_twist']}_sx{config['scale_x']}_sy{config['scale_y']}_sz{config['scale_z']}_h".replace('.', '_'), f"reference_cylinder_{config['deformation_bend']}_{config['deformation_twist']}_sx{config['scale_x']}_sy{config['scale_y']}_sz{config['scale_z']}_p".replace('.', '_'))
    # Point cloud
    plot_point_cloud_plotly(scaled_mesh['points'], 0, f"reference_cylinder_{config['deformation_bend']}_{config['deformation_twist']}_sx{config['scale_x']}_sy{config['scale_y']}_sz{config['scale_z']}_pc_h".replace('.', '_'), f"reference_cylinder_{config['deformation_bend']}_{config['deformation_twist']}_sx{config['scale_x']}_sy{config['scale_y']}_sz{config['scale_z']}_pc_p".replace('.', '_'))
    
    # Create logging directory
    ops.makedirs(config['log_directory'], exist_ok=True)
    
    # Saving complete reference mesh file
    tch.save(scaled_mesh, f"{config['log_directory']}/reference_cylinder_{config['deformation_bend']}_{config['deformation_twist']}_sx{config['scale_x']}_sy{config['scale_y']}_sz{config['scale_z']}_mesh.pth".replace('.', '_'))
    ...
    create_video_from_two_folders(f"{config['experiment_name']}_p", 
                                    ...
                                    f"reference_cylinder_{config['deformation_bend']}_{config['deformation_twist']}_sx{config['scale_x']}_sy{config['scale_y']}_sz{config['scale_z']}_p".replace('.', '_') + "/femesh_plot_iter_0.png", 
                                    f"reference_cylinder_{config['deformation_bend']}_{config['deformation_twist']}_sx{config['scale_x']}_sy{config['scale_y']}_sz{config['scale_z']}_pc_p".replace('.', '_') + "/femesh_plot_iter_0.png", 
