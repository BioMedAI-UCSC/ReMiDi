...
def main(config):
    ...
    # 3D Mesh
    plot_femesh_plotly_2(femesh_all_2, setup.pde['compartments'], 0, f"reference_cylinder_bamp{config['beading_amplitude']}_bnp{config['beading_num_periods']}_sx{config['scale_x']}_sy{config['scale_y']}_sz{config['scale_z']}_h".replace('.', '_'), f"reference_cylinder_bamp{config['beading_amplitude']}_bnp{config['beading_num_periods']}_sx{config['scale_x']}_sy{config['scale_y']}_sz{config['scale_z']}_p".replace('.', '_'))
    # Point cloud
    plot_point_cloud_plotly(femesh_all_2['points'], 0, f"reference_cylinder_bamp{config['beading_amplitude']}_bnp{config['beading_num_periods']}_sx{config['scale_x']}_sy{config['scale_y']}_sz{config['scale_z']}_pc_h".replace('.', '_'), f"reference_cylinder_bamp{config['beading_amplitude']}_bnp{config['beading_num_periods']}_sx{config['scale_x']}_sy{config['scale_y']}_sz{config['scale_z']}_pc_p".replace('.', '_'))
    
    # Create logging directory
    ops.makedirs(config['log_directory'], exist_ok=True)
    
    # Saving complete reference mesh file
    tch.save(femesh_all_2, f"{config['log_directory']}/reference_cylinder_bamp{config['beading_amplitude']}_bnp{config['beading_num_periods']}_sx{config['scale_x']}_sy{config['scale_y']}_sz{config['scale_z']}_mesh.pth".replace('.', '_'))
    ...
    create_video_from_two_folders(f"{config['experiment_name']}_p", 
                                    ...
                                    f"reference_cylinder_bamp{config['beading_amplitude']}_bnp{config['beading_num_periods']}_sx{config['scale_x']}_sy{config['scale_y']}_sz{config['scale_z']}_p".replace('.', '_') + "/femesh_plot_iter_0.png", 
                                    f"reference_cylinder_bamp{config['beading_amplitude']}_bnp{config['beading_num_periods']}_sx{config['scale_x']}_sy{config['scale_y']}_sz{config['scale_z']}_pc_p".replace('.', '_') + "/femesh_plot_iter_0.png", 
